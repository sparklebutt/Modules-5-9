...
/*   Updated: 2025/03/05 12:07:21 by araveala         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main( void )
{
	...
	::swap(test1, test2);
	std::cout<<"\033[0;31mvalues swapped\n\033[0mtest1 = "<<test1.value<<"\ntest2 = "<<test2.value<<"\n";
	std::cout<<"\033[0;31mvalues passed as non value swapped\n\033[0mtest1 = "<< test1<<"\ntest2 = "<<test2<<"\n";
	...
	std::cout << "before swap: aa = " << aa.getVal() << ", bb = " << bb.getVal() << std::endl;	
	::swap(aa, bb);
	std::cout << "after swap: aa = " << aa.getVal() << ", bb = " << bb.getVal() << std::endl;	
